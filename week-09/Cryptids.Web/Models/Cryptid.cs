...
public class Cryptid
{
    ...
    // Nullable on purpose: the registry predates both of these columns, and
    // records filed through the form arrive without them. A missing plate is
    // normal, not broken — the views fall back to the "artist unknown" image.
